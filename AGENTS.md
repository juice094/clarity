...
- **ADR-006 Phase A 已落地** (`c8e71fdb`, 2026-05-11)：deprecation 标记 (Gen-2/Gen-3)
- **ADR-006 Phase B 已落地** (`dd07b42f`, 2026-05-11)：删除 EventBus / sync_to_wire producer 路径 (-37 行)
- **ADR-006 Phase C.1 已落地** (`1c15621a`, 2026-05-11)：删除 Gen-2 整文件 (event.rs, -481 行)
