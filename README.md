...
1. **Gateway 渠道**: Discord/Telegram/Webhook 代码存在但未实测
2. **Web UI**: 还在画饼阶段
...
- [x] MCP Client + filesystem server 联调
- [x] Gateway Chat Completions SSE 流式输出
- [x] BackgroundTaskManager 活化（真实 Agent 执行）
