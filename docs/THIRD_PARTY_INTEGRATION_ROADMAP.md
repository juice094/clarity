...
- [`KIMI_CLI_COMPARISON.md`](./KIMI_CLI_COMPARISON.md) — 与 Kimi CLI 的详细横向对比
- [`mcp_integration_guide.md`](./mcp_integration_guide.md) — MCP 协议集成指南
- [`ROADMAP_ANALYSIS.md`](./ROADMAP_ANALYSIS.md) — 推进路线分析和选项对比
