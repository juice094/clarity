...
- **知识场** — 集成 clarity-knowledge，对话 turn 自动激活相关文件；`MemoryCompiler` 生成的 `.md` 记忆产物自动索引到知识场；`knowledge_search` 工具供 Agent 主动检索
- **审批系统** — Interactive / Smart / Plan / Yolo 四种模式控制工具执行权限
