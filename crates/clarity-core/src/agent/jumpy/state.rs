...
//! Jumpy State — Workflow execution state snapshot.
//!
//! Analogous to the RL "state" in Jumpy World Models.
//! Captures everything about the system that matters for planning
//! after a skill has executed.
