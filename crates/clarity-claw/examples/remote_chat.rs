...
//!     cargo run -p clarity-claw --example remote_chat

#![allow(clippy::unwrap_used, clippy::expect_used)]

use clarity_claw::client::{ClawClient, ClawResponse};
use std::io::Write;
...
fn main() {
    ...
    let device =
        clarity_claw::DeviceIdentity::load_or_generate().expect("load or generate device identity");
