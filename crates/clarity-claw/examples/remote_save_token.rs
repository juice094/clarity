...
//!
//! The saved record is read by `clarity_claw::load_paired_token()` and
...
//!     cargo run -p clarity-claw --example remote_save_token

#![allow(clippy::unwrap_used, clippy::expect_used)]

use clarity_claw::PairedToken;
...
fn main() {
    ...
    clarity_claw::save_paired_token(&record).expect("save paired token");
