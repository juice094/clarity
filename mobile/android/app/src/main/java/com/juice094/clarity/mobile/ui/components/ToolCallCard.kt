...
@Composable
fun ToolCallCard(toolName: String, argumentsJson: String, modifier: Modifier = Modifier) {
    ...
    Row(
        ...
        Card(
            colors = CardDefaults.cardColors(
                containerColor = ClarityColors.ToolBubble
            ),
            ...
            Column(modifier = Modifier.padding(12.dp)) {
                ...
                if (expanded) {
                    ...
                    FormattedJson(json = argumentsJson)
                }
            }
        }
    }
